...
# Creating track bar
#cv2.createTrackbar('hhh', 'HSV_TrackBar',0,179,nothing)
#cv2.createTrackbar('sss', 'HSV_TrackBar',0,255,nothing)
#cv2.createTrackbar('vvvv', 'HSV_TrackBar',0,255,nothing)
...
while(1):
    ...
    mask2 = cv2.inRange(hsv,np.array([2,50,50]),np.array([25,255,255]))
